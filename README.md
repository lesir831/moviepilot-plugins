...
适配 `pting.club` 当前 Next.js 登录系统的 MoviePilot V2 第三方插件。
...
在 MoviePilot 的插件市场添加本仓库地址：

```text
https://github.com/lesir831/moviepilot-fengchao-next
```

刷新插件市场后安装“蜂巢新版签到”。请停用旧版“蜂巢签到”，避免两个插件
同时执行。
